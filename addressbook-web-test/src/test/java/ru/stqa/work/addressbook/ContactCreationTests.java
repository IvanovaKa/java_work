...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    goToAddNewPage();
    fillContactForm();
    submitContactCraetion();
  }

  private void submitContactCraetion() {
  ...
  private void fillContactForm() {
    ...
    wd.findElement(By.name("home")).sendKeys("1111111");
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys("2222222");
    wd.findElement(By.name("work")).click();
    wd.findElement(By.name("work")).clear();
    wd.findElement(By.name("work")).sendKeys("3333333");
    wd.findElement(By.name("fax")).click();
    wd.findElement(By.name("fax")).clear();
    wd.findElement(By.name("fax")).sendKeys("4444444");
    ...
    wd.findElement(By.name("phone2")).sendKeys("5555555");
